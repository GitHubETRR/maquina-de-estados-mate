...
/*
    La diferencia con el MEF de 40ms es que con este nuevo delay de 500ms se 
    logra apreciar el funcionamiento de la función rising y falling de una mejor manera
*/
#include <stdio.h>
#define LED1 4
#define LED2 5
...
void reboteMEF_actualizar()
{
  switch (rebote){
    case BOTON_UP:     // Pasa a Fallling si se presiona
      ...
      break;
    case BOTON_FALLING:
        if(millis()-time>500){  //En caso de que se quiera que sea mas tiempo, se cambia el 40. 
...
//Si está en estado FALLING, espera un tiempo de 500 ms y vuelve a leer el pulsador, 
...
//Si está en estado RISING, espera un tiempo de 500 ms y vuelve a leer el pulsador,
